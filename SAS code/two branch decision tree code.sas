...
run;
*------------------------------------------------------------*;
* Variable Attributes for Tree3;
*------------------------------------------------------------*;
data WORK.Tree3_VariableAttribute;
...
value= "WORK.Tree3_VariableAttribute";
output;
id= "Tree3";
property="EM_DECMETA_like";
value= "WORK.Tree3_like_DM";
output;
id= "Tree3";
property="EM_DECDATA_like";
value= "WORK.Tree3_like_DD";
output;
id= "Tree3";
